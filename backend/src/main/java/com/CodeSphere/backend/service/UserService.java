...
public class UserService {
    ...
    /**
     * Updates a user's role privilege level in the system.
     * Resolves the AdminController error.
     */
    ...
    /**
     * Retrieves the primary database key ID linked to a specific username.
     * Resolves the AuthController error.
     */
    @Transactional(readOnly = true)
